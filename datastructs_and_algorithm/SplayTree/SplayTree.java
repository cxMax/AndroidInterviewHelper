...
/**
 * @describe : 伸展树 特点 : 当某个节点被访问时，伸展树会通过旋转使该节点成为树根
 * @usage : reference : http://www.cnblogs.com/skywang12345/p/3604286.html
 * <p>
 * </p>
...
public class SplayTree<T extends Comparable<T>> {
    ...
    private SplayTreeNode root;    // 根结点

    public static class SplayTreeNode<T extends Comparable<T>> {
        T key;				// 关键字(键值)
    ...
    public static class SplayTreeTest {
